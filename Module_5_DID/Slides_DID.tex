...
\NormalTok{scoresbase\textless{}{-}}\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{6}\NormalTok{,}\DecValTok{7}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{9}\NormalTok{,}\DecValTok{10}\NormalTok{),}\DataTypeTok{times=}\DecValTok{30}\NormalTok{))}
\KeywordTok{names}\NormalTok{(scoresbase)\textless{}{-}}\KeywordTok{c}\NormalTok{(}\StringTok{"class"}\NormalTok{)}
\NormalTok{scoresbase \textless{}{-}}\StringTok{ }\NormalTok{fastDummies}\OperatorTok{::}\KeywordTok{dummy\_cols}\NormalTok{(scoresbase, }\DataTypeTok{select\_columns =} \StringTok{"class"}\NormalTok{)}

\CommentTok{\#suppose the better teachers (classes, 7,8,9,10)}
\CommentTok{\#select to participate in the book club program}
\NormalTok{scoresbase}\OperatorTok{$}\NormalTok{treat\textless{}{-}}\DecValTok{0}
\NormalTok{scoresbase}\OperatorTok{$}\NormalTok{treat[scoresbase}\OperatorTok{$}\NormalTok{class}\OperatorTok{\%in\%}\KeywordTok{c}\NormalTok{(}\DecValTok{7}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{9}\NormalTok{,}\DecValTok{10}\NormalTok{)]\textless{}{-}}\DecValTok{1}
\end{Highlighting}
\end{Shaded}
\end{frame}
...
\NormalTok{  name\textless{}{-}}\KeywordTok{paste}\NormalTok{(}\StringTok{"scores"}\NormalTok{, yr[i], }\DataTypeTok{sep=}\StringTok{"\_"}\NormalTok{)}
\NormalTok{  scores\textless{}{-}scoresbase}
\NormalTok{  scores}\OperatorTok{$}\NormalTok{error\textless{}{-}}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{300}\NormalTok{, }\DataTypeTok{mean=}\DecValTok{0}\NormalTok{, }\DataTypeTok{sd=}\DecValTok{10}\NormalTok{)}
\NormalTok{  tau\textless{}{-}tauyr[i]}
\NormalTok{  yearfe\textless{}{-}yrfe[i]}
  \CommentTok{\#the data generating process}
\NormalTok{  scores}\OperatorTok{$}\NormalTok{read4\textless{}{-}(yearfe}\OperatorTok{+}\NormalTok{tau}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{treat}\OperatorTok{+}\NormalTok{scores}\OperatorTok{$}\NormalTok{error}
               \OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{10}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{1}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{15}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{2}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{5}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{3}
               \OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{8}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{4}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{7}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{5}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{13}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{6}
               \OperatorTok{+}\NormalTok{(}\DecValTok{11}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{7}\OperatorTok{+}\NormalTok{(}\DecValTok{8}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{8}\OperatorTok{+}\NormalTok{(}\DecValTok{10}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{9}
               \OperatorTok{+}\NormalTok{(}\DecValTok{12}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{10}\NormalTok{)}

\NormalTok{  scores}\OperatorTok{$}\NormalTok{year\textless{}{-}yr[i]}
  \KeywordTok{assign}\NormalTok{(name, scores)}
  \KeywordTok{rm}\NormalTok{(scores)}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{allscores}\OperatorTok{$}\NormalTok{post\textless{}{-}}\DecValTok{0}
\NormalTok{allscores}\OperatorTok{$}\NormalTok{post[allscores}\OperatorTok{$}\NormalTok{year}\OperatorTok{\%in\%}\KeywordTok{c}\NormalTok{(}\DecValTok{2001}\NormalTok{,}\DecValTok{2002}\NormalTok{,}\DecValTok{2003}\NormalTok{,}\DecValTok{2004}\NormalTok{,}\DecValTok{2005}\NormalTok{)]\textless{}{-}}\DecValTok{1}

\NormalTok{allscores \textless{}{-}}\StringTok{ }\NormalTok{fastDummies}\OperatorTok{::}\KeywordTok{dummy\_cols}\NormalTok{(allscores, }\DataTypeTok{select\_columns =} \StringTok{"year"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{grp\_mean}\OperatorTok{$}\NormalTok{treat\textless{}{-}}\KeywordTok{as.factor}\NormalTok{(grp\_mean}\OperatorTok{$}\NormalTok{treat)}

\CommentTok{\#difference in means plot}
\NormalTok{didmeans\textless{}{-}}\KeywordTok{ggplot}\NormalTok{(grp\_mean, }\KeywordTok{aes}\NormalTok{(year, groupmean, }\DataTypeTok{group=}\NormalTok{treat, }\DataTypeTok{color =}\NormalTok{ treat)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{stat\_summary}\NormalTok{(}\DataTypeTok{geom =} \StringTok{\textquotesingle{}line\textquotesingle{}}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom\_vline}\NormalTok{(}\DataTypeTok{xintercept =} \DecValTok{2000}\NormalTok{) }\OperatorTok{+}
...
\NormalTok{res\textless{}{-}}\KeywordTok{coef}\NormalTok{(}\KeywordTok{summary}\NormalTok{(regdidall2))}
\NormalTok{res\textless{}{-}}\KeywordTok{as.data.frame}\NormalTok{(res)}

\NormalTok{res\textless{}{-}res[}\DecValTok{13}\OperatorTok{:}\DecValTok{22}\NormalTok{,]}

\NormalTok{a\textless{}{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{)}

\NormalTok{res\textless{}{-}}\KeywordTok{rbind}\NormalTok{(res,a)}

\NormalTok{year\textless{}{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{1995}\NormalTok{,}\DecValTok{1996}\NormalTok{,}\DecValTok{1997}\NormalTok{,}\DecValTok{1998}\NormalTok{,}\DecValTok{1999}\NormalTok{,}\DecValTok{2001}\NormalTok{,}\DecValTok{2002}\NormalTok{,}\DecValTok{2003}\NormalTok{,}\DecValTok{2004}\NormalTok{,}\DecValTok{2005}\NormalTok{,}\DecValTok{2000}\NormalTok{)}
\NormalTok{res\textless{}{-}}\KeywordTok{cbind}\NormalTok{(res,year)}
\NormalTok{res}\OperatorTok{$}\NormalTok{ci\textless{}{-}}\FloatTok{1.96}\OperatorTok{*}\NormalTok{res}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Std. Error}\StringTok{\textasciigrave{}}

\KeywordTok{names}\NormalTok{(res)\textless{}{-}}\KeywordTok{c}\NormalTok{(}\StringTok{"Estimate"}\NormalTok{,}\StringTok{"se"}\NormalTok{, }\StringTok{"t"}\NormalTok{,  }\StringTok{"p"}\NormalTok{, }\StringTok{"year"}\NormalTok{, }\StringTok{"ci"}\NormalTok{)}
\CommentTok{\# Use 95\% confidence interval instead of SEM}
\NormalTok{didplot2\textless{}{-}}\KeywordTok{ggplot}\NormalTok{(res, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{year, }\DataTypeTok{y=}\NormalTok{Estimate)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{Estimate}\OperatorTok{{-}}\NormalTok{ci, }\DataTypeTok{ymax=}\NormalTok{Estimate}\OperatorTok{+}\NormalTok{ci),}\DataTypeTok{width=}\NormalTok{.}\DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom\_vline}\NormalTok{(}\DataTypeTok{xintercept =} \DecValTok{2000}\NormalTok{)}\OperatorTok{+}
...
\NormalTok{scores}\OperatorTok{$}\NormalTok{aftsch\textless{}{-}}\KeywordTok{rbinom}\NormalTok{(}\DecValTok{300}\NormalTok{,}\DecValTok{1}\NormalTok{,}\FloatTok{0.5}\NormalTok{)}
...
\NormalTok{scores}\OperatorTok{$}\NormalTok{treatnotaftsch\textless{}{-}}\DecValTok{0}
\NormalTok{scores}\OperatorTok{$}\NormalTok{treatnotaftsch[scores}\OperatorTok{$}\NormalTok{treat}\OperatorTok{==}\DecValTok{1} \OperatorTok{\&}\StringTok{ }\NormalTok{scores}\OperatorTok{$}\NormalTok{aftsch}\OperatorTok{==}\DecValTok{0}\NormalTok{]\textless{}{-}}\DecValTok{1}

\CommentTok{\#the treatment effect}
\NormalTok{tau\textless{}{-}}\DecValTok{10}

\CommentTok{\#the data generating process}
\NormalTok{scores}\OperatorTok{$}\NormalTok{read4\textless{}{-}(}\DecValTok{85}\OperatorTok{+}\DecValTok{13}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{aftsch}\OperatorTok{+}\NormalTok{tau}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{treatnotaftsch}\OperatorTok{+}\NormalTok{scores}\OperatorTok{$}\NormalTok{error}
               \OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{10}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{1}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{15}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{2}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{5}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{3}
               \OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{8}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{4}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{5}\OperatorTok{+}\NormalTok{(}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{6}
               \OperatorTok{+}\NormalTok{(}\DecValTok{5}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{7}\OperatorTok{+}\NormalTok{(}\DecValTok{8}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{8}\OperatorTok{+}\NormalTok{(}\DecValTok{10}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{9}\OperatorTok{+}\NormalTok{(}\DecValTok{12}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{10}\NormalTok{)}
...
\CommentTok{\#the data generating process}
\NormalTok{scores}\OperatorTok{$}\NormalTok{read4\textless{}{-}(}\DecValTok{78}\OperatorTok{+}\DecValTok{18}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{aftsch}\OperatorTok{+}\NormalTok{scores}\OperatorTok{$}\NormalTok{error}
               \OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{10}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{1}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{15}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{2}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{5}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{3}
               \OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{8}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{4}\OperatorTok{+}\NormalTok{(}\OperatorTok{{-}}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{5}\OperatorTok{+}\NormalTok{(}\DecValTok{3}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{6}
               \OperatorTok{+}\NormalTok{(}\DecValTok{5}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{7}\OperatorTok{+}\NormalTok{(}\DecValTok{8}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{8}\OperatorTok{+}\NormalTok{(}\DecValTok{10}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{9}
               \OperatorTok{+}\NormalTok{(}\DecValTok{12}\NormalTok{)}\OperatorTok{*}\NormalTok{scores}\OperatorTok{$}\NormalTok{class\_}\DecValTok{10}\NormalTok{)}
...
\NormalTok{regdid3d\textless{}{-}}\KeywordTok{felm}\NormalTok{(read4}\OperatorTok{\textasciitilde{}}\NormalTok{post}\OperatorTok{+}\NormalTok{treat}\OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{treat}\OperatorTok{|}\DecValTok{0}\OperatorTok{|}\DecValTok{0}\OperatorTok{|}\NormalTok{class,scores)}

\NormalTok{regdid3dinter\textless{}{-}}\KeywordTok{felm}\NormalTok{(read4}\OperatorTok{\textasciitilde{}}\NormalTok{post}\OperatorTok{+}\NormalTok{treat}\OperatorTok{+}\NormalTok{aftsch}
                    \OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{treat}\OperatorTok{+}\NormalTok{treat}\OperatorTok{*}\NormalTok{aftsch}\OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{aftsch}
                    \OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{aftsch}\OperatorTok{*}\NormalTok{treat}
                    \OperatorTok{|}\DecValTok{0}\OperatorTok{|}\DecValTok{0}\OperatorTok{|}\NormalTok{class,}
\NormalTok{                    scores)}

\NormalTok{regdid3dinterfe\textless{}{-}}\KeywordTok{felm}\NormalTok{(read4}\OperatorTok{\textasciitilde{}}\NormalTok{post}\OperatorTok{+}\NormalTok{treat}\OperatorTok{+}\NormalTok{aftsch}
                    \OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{treat}\OperatorTok{+}\NormalTok{treat}\OperatorTok{*}\NormalTok{aftsch}\OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{aftsch}
                    \OperatorTok{+}\NormalTok{post}\OperatorTok{*}\NormalTok{aftsch}\OperatorTok{*}\NormalTok{treat}
                    \OperatorTok{|}\NormalTok{class}\OperatorTok{|}\DecValTok{0}\OperatorTok{|}\NormalTok{class,}
\NormalTok{                    scores)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{"C:/Users/Claire/Dropbox/MQE_CI_Fall2020/Lecture Notes/PanelRollout.png"}
