...
Step 1: Selecting a bandwidth, $b$, that will determine the regression sample on either side of the threshold point $c$.
...
For the sample with $c-h \leq R_i< c+h$ we run some version (you can include covariates) of the following IV regression
$$
